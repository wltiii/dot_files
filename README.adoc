...
|git-upstreams |git fetch --all; git branch -vv |fetches then shows current branch
|git-remote    |git remote get-url origin .     |use `git remote show origin` for a complete info
|===
