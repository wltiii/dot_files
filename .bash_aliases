...
alias git-merge-to-main-and-delete-help='merges the branch to main and deletes the branch'
...
alias git-safe-merge-main-into-help='merges latest main into branch safely (i.e. nothing to commit)'
