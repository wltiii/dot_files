...
alias fvm-install-global='fvm install "$@" && fvm global "$@"'
alias fvm-list='fvm list'
alias fvm-list-releases='fvm releases'
alias fvm-list-beta-releases='fvm-releases | grep beta'
alias fvm-list-stable-releases='fvm-releases | grep stable'
